    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            showDetails: function (index) {
                var showDetailed = this.items[index].detailed;
                this.items[index].detailed = !showDetailed;
            },
            ...
            startWs: function () {
                ...
                ws.onmessage = function (evt) {
                    ...
                    vue.items.push({time: new Date().toLocaleTimeString(), query: data.Query, detailed: false});
                }
